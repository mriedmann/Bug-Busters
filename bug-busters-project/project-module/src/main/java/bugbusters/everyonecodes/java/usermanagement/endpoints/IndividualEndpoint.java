...
public class IndividualEndpoint {
    ...
    @GetMapping("/login")
    UserPrivateDTO viewIndividualPrivateData(Authentication authentication) {
        return individualService.viewIndividualPrivateData(authentication.getName()).orElse(null);
    }

    @PutMapping("/edit")
    UserPrivateDTO editIndividualData(@Valid @RequestBody UserPrivateDTO edits, Authentication authentication) {
        return individualService.editIndividualData(edits, authentication.getName()).orElse(null);
    }

    @GetMapping("/view")
    UserPublicDTO viewIndividualPublicData(Authentication authentication) {
